...
from app_v2.models.common import CoverageCaseStatus, ShiftStatus
from app_v2.models.coverage import CoverageCase
from app_v2.models.scheduling import Shift
from app_v2.models.scheduling import ShiftAssignment
from app_v2.schemas.scheduling import ShiftCreate, ShiftUpdate
...
async def create_shift(session: AsyncSession, business_id: UUID, payload: ShiftCreate) -> Shift:
    ...
    if enabled_role is None:
        raise LookupError("location_role_not_enabled")
