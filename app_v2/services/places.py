...
def _google_headers(field_mask: str) -> dict[str, str]:
    return {
        ...
        "X-Goog-Api-Key": v2_settings.google_places_api_key,
...
async def _run_text_search(
    ...
    *,
    ...
    text_search_body: dict[str, Any] = {
        "textQuery": query,
        "languageCode": "en",
        "regionCode": v2_settings.google_places_region_code,
    }
    if location_bias:
        text_search_body["locationBias"] = location_bias
    if rank_by_distance:
        text_search_body["rankPreference"] = "DISTANCE"
    if v2_settings.google_places_country_codes:
        text_search_body["includedRegionCodes"] = v2_settings.google_places_country_codes
...
async def autocomplete_places(
    ...
    *,
    ...
    if not v2_settings.backfill_google_places_enabled or not v2_settings.google_places_api_key:
    ...
    if v2_settings.google_places_country_codes:
        body["includedRegionCodes"] = v2_settings.google_places_country_codes
