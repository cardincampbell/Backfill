...
import {
  updateV2LocationSettings,
  type V2LocationSettings,
} from "@/lib/api/v2-workspace";

type V2LocationSettingsPanelProps = {
  businessId: string;
  locationId: string;
  settings: V2LocationSettings;
};
...
export function V2LocationSettingsPanel({
  businessId,
  locationId,
  settings,
}: V2LocationSettingsPanelProps) {
  ...
  async function handleSave() {
    ...
    setFeedback(null);
    try {
      await updateV2LocationSettings(businessId, locationId, {
        ...
        <div className="settings-card-body">
          ...
          <div className="settings-field">
            ...
            <select
              ...
              onChange={(event) =>
                setLatePolicy(
                  event.target.value as V2LocationSettings["late_arrival_policy"],
                )
              }
            >
          ...
          <div className="settings-field">
            ...
            <select
              ...
              onChange={(event) =>
                setMissedPolicy(
                  event.target.value as V2LocationSettings["missed_check_in_policy"],
                )
              }
            >
      ...
      <div className="settings-card">
        ...
        <div className="settings-card-body">
          ...
          <div className="settings-field">
            ...
            <div className="v2-role-chip-row">
