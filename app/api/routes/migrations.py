...
async def run_migrations(
    ...
    """Manually trigger Alembic migrations using an advisory lock.

    This endpoint is intended for operational use when
    BACKFILL_RUN_MIGRATIONS_ON_STARTUP is disabled. It runs the same
    advisory-lock-guarded migration logic that would otherwise execute at
    startup.
    """
    ...
    return MigrationRunResponse(status="ok", message="Migrations applied successfully")
