...
from app.services import rate_limit, scheduler_sync
from app.services.scheduler_adapters import webhook_secret_for_connection

router = APIRouter(prefix="/providers/schedulers", tags=["scheduler-providers"])
...
async def _handle_webhook(
    ...
    *,
    ...
    await rate_limit.assert_within_limit(
        "scheduler_webhook",
        client_ip,
        limit=settings.scheduler_webhook_limit_per_minute,
        window_seconds=60,
