...
from app.models.common import AuditActorType, InviteStatus, MembershipRole
from app.models.identity import ManagerInvite
from app.schemas.auth import OTPChallengeRequest
...
from app.services import auth as auth_service, invites, rate_limit
...
async def get_manager_invite_preview(token: str, session: SessionDep):
    ...
    return ManagerInvitePreviewResponse(
        ...
        business_name=preview.business.display_name,
        location_id=preview.location.id,
        location_name=preview.location.display_name,
