...
class PlatformEventType:
    ...
    SCHEDULE_SHIFT_AMENDED = "schedule.shift.amended"
    ...
    COVERAGE_OUTREACH_ATTEMPT_QUEUED = "coverage.outreach_attempt.queued"
    COVERAGE_OUTREACH_ATTEMPT_AWAITING_RESPONSE = "coverage.outreach_attempt.awaiting_response"
    COVERAGE_OUTREACH_ATTEMPT_ACCEPTED = "coverage.outreach_attempt.accepted"
    COVERAGE_OUTREACH_ATTEMPT_DECLINED = "coverage.outreach_attempt.declined"
    COVERAGE_OUTREACH_ATTEMPT_EXPIRED = "coverage.outreach_attempt.expired"
    COVERAGE_OUTREACH_ATTEMPT_CANCELLED = "coverage.outreach_attempt.cancelled"
    COVERAGE_OUTREACH_ATTEMPT_FAILED = "coverage.outreach_attempt.failed"
