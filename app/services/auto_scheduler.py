...
async def create_schedule_run(
    ...
    *,
    ...
    schedule_run_input = ScheduleRunInput(
        ...
        generated_demand_payload=inputs.generated_demand_payload.model_dump(mode="json"),
        employee_payload=inputs.employee_payload,
        availability_payload=inputs.availability_payload,
        policy_payload=inputs.policy_payload.model_dump(mode="json"),
        labor_payload=inputs.labor_payload,
        reliability_payload=inputs.reliability_payload.model_dump(mode="json"),
