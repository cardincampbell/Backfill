...
from app.services.payload_utils import stable_payload_hash
...
def build_labor_forecast_contract(
    *,
    ...
    demand_feature_snapshot_id: UUID | None = None,
...
async def create_labor_forecast_run(
    ...
    *,
    ...
    forecast_run = LaborForecastRun(
        ...
        demand_feature_snapshot_id=contract.demand_feature_snapshot_id,
