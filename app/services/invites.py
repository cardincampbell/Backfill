...
from app.models.common import InviteStatus, MembershipRole, MembershipStatus
from app.models.identity import ManagerInvite, Membership, User
...
def build_manager_invite_link(raw_token: str) -> str:
    return f"{settings.web_base_url}/onboarding?invite={quote(raw_token)}"
